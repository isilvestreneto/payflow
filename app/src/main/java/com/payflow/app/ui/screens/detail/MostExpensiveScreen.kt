...
fun MostExpensiveScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Assinatura Mais Cara") },
                navigationIcon = {
        ...
        if (subscription == null) {
            ...
            Column(
                ...
                Text(
                    text = currencyFormat.format(subscription.value),
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Esta é sua assinatura mais cara. Avalie se o custo-benefício vale a pena.",
